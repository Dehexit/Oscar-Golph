...
int _main (int , char ** )
{
	...
	*/
	...
	/*
	CONTESTACIÓN: crear la ventana y pintar en la ventana lo que hay que pintar es responsabilidad del componente renderer. Actualiza la superifice, 
	hace el swap de buffers... 
	*/
